...
class CoordinatorResult:
    ...
    Attributes:
        ...
        backend_type: Runtime backend used
    """
...
class InferenceCoordinator:
    ...
    def __init__(
        ...
        engine: PureInferenceEngine | None = None,
        postprocessor: PostprocessorBase | None = None,
    ):
        ...
        self._backend_type = self._engine.backend_type
